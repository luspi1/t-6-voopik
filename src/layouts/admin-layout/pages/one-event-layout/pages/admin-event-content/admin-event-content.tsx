...
import {
	...
	eventContentSchema,
} from 'src/layouts/admin-layout/pages/one-event-layout/pages/admin-event-content/schema'
...
import { PreviewSection } from 'src/layouts/admin-layout/pages/one-event-layout/pages/admin-event-content/components/preview-section/preview-section'
