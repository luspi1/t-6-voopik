import { type EventRegInputs } from 'src/layouts/admin-layout/pages/one-event-layout/pages/admin-event-reg/schema'
...
import regStyles from 'src/layouts/admin-layout/pages/one-event-layout/pages/admin-event-reg/index.module.scss'
